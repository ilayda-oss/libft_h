...
ft_strncmp.c ft_calloc.c ft_atoi.c ft_strrchr.c ft_strlcpy.c \
ft_strlen.c ft_strnstr.c ft_strchr.c ft_tolower.c ft_toupper.c \
ft_memcmp.c ft_memset.c ft_strdup.c ft_substr.c ft_strjoin.c \
ft_itoa.c ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_putstr_fd.c \
ft_putendl_fd.c ft_putnbr_fd.c ft_strlcat.c ft_strtrim.c ft_split.c
OBJS = $(SRCS:.c=.o)
